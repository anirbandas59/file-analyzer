...
class FileAnalyzerLogger:
    ...
    def log_ui_action(self, action: str, component: str, details: dict = None):
        """Log UI interactions."""
...
def error(message: str, exception: Exception = None, **kwargs):
    """Log error message."""
    logger.error(message, exception, **kwargs)


def critical(message: str, exception: Exception = None, **kwargs):
...
def log_ui_action(action: str, component: str, details: dict = None):
    """Log UI interactions."""
