...
from ..models.management_data import (
    FileInfo, FileAgeAnalysis, FileAgeCategory, FileSizeCategory
)
...
class FileAgeAnalysisService:
    ...
    def get_age_distribution_stats(self, analysis: FileAgeAnalysis) -> Dict[FileAgeCategory, Dict]:
        """
    ...
    def get_archival_recommendations(self, analysis: FileAgeAnalysis, 
                                   min_age_days: int = 365,
                                   min_size_mb: int = 10) -> List[Dict]:
        """
            ...
            if len(files) >= 5:  # At least 5 files of this type
                ...
                if total_size >= 50 * 1024 * 1024:  # At least 50MB total
                    ...
                    recommendations.append({
                        ...
                        'size': total_size,
                        'file_type': file_type,
                        'files': sorted(files, key=lambda f: f.size, reverse=True)[:5]
                    })
        
        return recommendations
    
    def get_cleanup_candidates(self, analysis: FileAgeAnalysis,
                             include_stale: bool = True,
                             min_size_mb: int = 1) -> List[FileInfo]:
        """
    ...
    def export_analysis_results(self, analysis: FileAgeAnalysis, 
    ...
    def _export_to_csv(self, analysis: FileAgeAnalysis) -> str:
        ...
        writer.writerow([
            ...
            'Age Category', 'Last Modified', 'File Type', 'Days Old'
        ])
