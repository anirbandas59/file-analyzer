...
from ..themes.styles import ModernTheme, Spacing, Typography, BorderRadius, Shadows
...
class TitleCard(CardWidget):
    ...
    def create_header(self):
        ...
        self.header_layout.setContentsMargins(Spacing.MD, Spacing.MD, Spacing.MD, Spacing.SM)
...
class ActionCard(TitleCard):
    ...
    def add_action_button(self, button):
        ...
        stretch_item = self.actions_layout.takeAt(self.actions_layout.count() - 1)
