...
class BaseChart(CardWidget):
    ...
    @abstractmethod
    def update_data(self, data: Any, metadata: Optional[ChartMetadata] = None):
    ...
    def export_as_image(self, file_path: str, width: int = 800, height: int = 600) -> bool:
        """
    ...
    def get_metadata(self) -> Optional[ChartMetadata]:
