...
class DirectoryNode:
    ...
    file_type: Optional[str] = None  # File extension if is_file=True
...
class ChartDataTransformer:
    ...
    @staticmethod
    def files_to_directory_hierarchy(file_list: List[Dict[str, Any]], 
                                   root_path: str = "") -> DirectoryNode:
    ...
    @staticmethod
    def files_to_top_files(file_list: List[Dict[str, Any]], 
                          limit: int = 20) -> List[TopFilesData]:
